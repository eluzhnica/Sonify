...
/**
 * Consult java.sound.midi and oracle forum
 * 
 */
public class MidiPlayer {
    ...
    private int getOffset(String note) {
        ...
        if (note.equalsIgnoreCase("Bb")) {
            return 10;
        }
        if (note.equalsIgnoreCase("B")) {
            return 11;
        }
        if (note.equalsIgnoreCase("Cb")) {
            return 11;
        } else {
